...
export default function OrderListCanceled({ orders }) {
            ...
            <GridItem xs={12} sm={12} md={12}>
                <Card>
                    <CardHeader color="primary">
                        <h4 className={classes.cardTitleWhite}>Pedidos Cancelados</h4>
                        <p className={classes.cardCategoryWhite}>
                            Tabla para la visualización de pedidos que han sido cancelados.
                        </p>
                    </CardHeader>
                    <CardBody>
                        {
                            ...
                            tableHead={["Id del Pedido", "Pedido por: ", "Total pagado: ", "Estado del pedido", "Fecha del pedido", "Visualizar detalles"]}
                            tableData={
                                map(orders, (order) => [
