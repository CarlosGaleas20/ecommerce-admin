...
export default function ClientModal({ open, setOpen, setReloadOrder }) {
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                        <Card>
                            <CardHeader color="primary">
                                <h4 className={classes.cardTitleWhite}>Agrega un nuevo Cliente</h4>
                                <p className={classes.cardCategoryWhite}>Completa el formulario para agregar un cliente:</p>
                            </CardHeader>
