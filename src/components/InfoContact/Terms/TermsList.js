            ...
            <GridItem xs={12} sm={12} md={12}>
                <Card>
                    <CardHeader color="primary">
                        <h4 className={classes.cardTitleWhite}>Términos y Condiciones</h4>
                        <p className={classes.cardCategoryWhite}>
                            Tabla para le gestión de términos y condiciones existentes.
                        </p>
                    </CardHeader>
                    <Button
                        color="primary"
                    ...
                    >
                        Agregar nuevo Término o Condición
                    </Button>
                    <CardBody>
                        <Table
                            tableHeaderColor="primary"
                            tableHead={["Título", "Descripción", "Acción"]}
                            tableData={
