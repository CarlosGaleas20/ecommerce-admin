        ...
        if (terms.titulo && terms.descripcion) {
            try {
                ...
                if (response.statusCode === 500) {
                    ...
                    toast.success('Término o condición modificada correctamente');
                    setOpen(false);
                    setReloadTerms(true);
                    setTerms({
                        titulo: '',
                ...
                <AppBar className={classes.appBar}>
                    <Toolbar>
                        ...
                        <Typography variant="h6" className={classes.title}>
                            Término o Condición: {activeEdit.titulo}
                        </Typography>
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                        <Card>
                            <CardHeader color="primary">
                                <h4 className={classes.cardTitleWhite}>Modifíca un Término o Condición</h4>
                                <p className={classes.cardCategoryWhite}>Completa el formulario para modificar un Término o Condición:</p>
                            </CardHeader>
