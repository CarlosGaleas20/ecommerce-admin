            ...
            if (activeImage) {
                try {
                    ...
                    if (response.statusCode === 500) {
                        toast.error('El nombre de la categoría ya existe. Cambie el nombre para modificar');
                    } else {
                ...
                <AppBar className={classes.appBar}>
                    <Toolbar>
                        ...
                        <Typography variant="h6" className={classes.title}>
                            Editar la categoría: {activeEdit.title}
                        </Typography>
                        <Button
                            disabled={loading}
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                        <Card>
                            <CardHeader color="primary">
                                <h4 className={classes.cardTitleWhite}>Modifica una Categoría</h4>
                                <p className={classes.cardCategoryWhite}>Completa el formulario para modificar una categoría:</p>
                            </CardHeader>
